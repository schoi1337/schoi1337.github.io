...
Privilege escalation came from a custom binary that used system() unsafely, enabling command injection via command-line arguments.
Soccer showcases how insecure dev routes and sloppy privilege boundaries can lead to full compromise with minimal tooling.
