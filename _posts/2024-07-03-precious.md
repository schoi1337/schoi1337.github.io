...
Privilege escalation was achieved by exploiting a script that used os.system insecurely with user-controlled input.
This machine highlights the dangers of unsafe deserialization in common libraries and reminds us that file processing tools can be powerful attack surfaces.
